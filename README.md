...
| [`Archive-Performance-Tests`](src/Archive-Performance-Tests/) | hand-written | Performance benchmarks (`LAArchivePerformanceTest`), not loaded by default — run via the `Performance` group. |
